...
function makeCAMReport(overrides: Partial<CamReport> = {}): CamReport {
  return {
    ...
    aiRiskSummary: `This Credit Appraisal Memo was AI-generated by Claude (Claude AI) based on KYC data, bank statement analysis, GST records, and bureau reports.
...
AI Recommendation: STRONG APPROVAL candidate. Recommend proceeding to CAM generation at full requested limit.`,
  ...
  // ── CAM GENERATED (4) ─────────────────────────────────────────────────
  {
    ...
    activity: makeActivity([
      ...
      { action: 'CAM_GENERATED', from: 'PENNY_DROP_DONE', to: 'CAM_GENERATED', note: 'CAM auto-generated by AI. Score: 71/100. Grade: A.', by: 'AI Engine (Claude AI)', at: '2026-04-05T15:30:00Z' },
    ]),
  },
  ...
  // ── CAM GENERATED (5) ─────────────────────────────────────────────────
  {
    ...
    activity: makeActivity([
      ...
      { action: 'CAM_GENERATED', from: 'PENNY_DROP_DONE', to: 'CAM_GENERATED', note: 'CAM generated. Score 61/100. Recommend ₹20L vs ₹25L requested.', by: 'AI Engine (Claude AI)', at: '2026-04-06T10:00:00Z' },
    ]),
  },
